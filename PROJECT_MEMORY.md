...
* **สถานะ:** `preorder` · เปิดสั่งแล้วที่ `kuapapoh.com/preorder/#bag` (หน้าพรีออเดอร์เดียวกับเสื้อ ส่วน `#bag`) · **ราคา 250 บาทต่อใบ** · ผ้าแคนวาส · ขนาด 13 x 15 นิ้ว · **จำนวนจำกัด ช้าหมดอด (เจ้าของสั่ง 2026-09-23 ห้ามประกาศตัวเลขจำนวนใบในข้อความที่ผู้ใช้เห็นหรือ SEO)** · ค่าส่ง/การรับของเหมือนเสื้อ (ส่งไปรษณีย์ 50 บาทต่อออเดอร์ หรือรับเองบ้าน 78 ฟรี) · การ์ด/modal/JSON-LD ใช้ราคา 250 + `offers` PreOrder · ปุ่มหลักใน modal เป็น `<a href="preorder/#bag">สั่งกระเป๋า ฿250</a>` + ปุ่มรอง LINE `https://line.me/R/ti/p/%40kuapapoh` ข้อความ "สอบถามทาง LINE"
* **id สินค้า:** `je-bag` วางลำดับที่ 2 ต่อจาก `je-shirt` · หมวด `กระเป๋า & ของใช้` · tag `จำนวนจำกัด · เทศกาลกินผัก` · meta `ผ้าแคนวาส · 13 x 15 นิ้ว · เหลือง / แดง` · modal `modal-bag` (แกลเลอรี thumbs 6 ภาพ (กระเป๋าล้วน · วาสั่งตัดภาพท่าทาง+แบบร่างออก ดูยัดเยียด) + เรื่องน้องจำปูน + รายการสเปกสั้น)
* **สเปกที่ประกาศได้:** 2 สี เหลือง / แดง · ลายสกรีนชุดเดียวกับเสื้อเทศกาลกินผัก (ศาลเจ้า มังกร เสือ เตาไฟ ประทัด + KUAPAPOH) มีน้องจำปูนแอบในลาย · พรีเซนเตอร์ น้องจำปูน (สะกด "จำปูน" ทุกที่ · อังกฤษ "Jampoon") · modal มีรายการสเปก `สี: เหลือง · แดง` / `ผ้า: ผ้าแคนวาส` / `ขนาด: 13 x 15 นิ้ว` / `จำนวนจำกัด ช้าหมดอด` · ห้ามระบุวันขาย · ห้ามระบุตัวเลขจำนวนใบทุกที่ · สต็อกจริงในระบบยังกันที่ `BAG_STOCK` ใน `functions/api/_shared.js` ปรับได้ที่เดียว (ดูค่าปัจจุบันในไฟล์นั้น ห้ามเอาตัวเลขมาโชว์หน้าเว็บ)
